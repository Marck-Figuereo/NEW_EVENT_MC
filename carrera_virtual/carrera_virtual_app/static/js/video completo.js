...
var screen_name_race   = document.getElementById("container-resultado-race");
var screen_name_odds   = document.getElementById("container-resultado-odds");
...
cerrar_to = () =>{
  ...
  if (video_race.currentTime == 0 &&  screen_resultados.style.opacity == 0 && screen_bono.style.opacity == 0 && screen_jp.style.opacity == 0){
    ...
    screen_name_race.style.opacity = 0
    screen_name_odds.style.opacity = 0
...
const excute_race = async () =>{
  ...
  //console.log(vid);
    ...
    video_race.src                = `static/videos/prueba.mov`;
    video_race.type               = 'video/mov';
...
video_race.addEventListener('playing', async () => {
  ...
  $('#race_n').text('465')
  screen_name_race.style.opacity  = 1

  $('#n_directa').text('12.1')
  $('#n_pale').text('89.2')
  await esperar(42000)
  screen_name_odds.style.opacity  = 1
